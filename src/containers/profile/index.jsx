          ...
          <div className="profile__actions">
            {report != null && (
              <a
                target="_blank"
                rel="noopener"
                href={`https://twitter.com/intent/tweet?original_referer=https://githubwrapper.techF&ref_src=twsrc%5Etfw&text=In 2020 I made over ${report.commits}%2B commits and ${report.pullrequests} Pull Requests towards open-source! Check how your #GitHubWrapped in 2020 at&tw_p=tweetbutton&url=githubwrapper.tech`}
                className="tweet-btn"
              >
                <img
